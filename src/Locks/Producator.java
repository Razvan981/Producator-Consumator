...
* metoda append(int) din clasa PCLock pentru a adauga elemente in buffer.
* <p>
...
public class Producator extends Thread {
	...
	public Producator(int nr_fireP, int nr_fir, int min, int max, PCLock buffer) {
    ...
    /**
	   ...
	   * a-l introduce in buffer prin intermediul metodei append(int) din clasa PCLock.
	   * <p>
